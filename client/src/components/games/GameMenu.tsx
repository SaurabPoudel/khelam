...
const GameMenu = () => {
  ...
  return (
    ...
    <button className="bg-green-500 hover:bg-green-700 text-black hover:text-white py-2 px-4 hover:scale-[1.1] rounded mx-20" onClick={()=> router(game.slug)} > Play </button>
    </div>
    ))}    
    </div>
    </div>
